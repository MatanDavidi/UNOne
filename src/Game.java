...
public class Game extends JPanel {
    ...
    private void initComponents() {
        ...
        discardedButton = new javax.swing.JButton();

        playerOnePanel.setLayout(new java.awt.BorderLayout());
        add(playerOnePanel, java.awt.BorderLayout.PAGE_END);

        playerTwoPanel.setLayout(new java.awt.BorderLayout());
        add(playerTwoPanel, java.awt.BorderLayout.PAGE_START);

        playerThreePanel.setLayout(new java.awt.BorderLayout());
        add(playerThreePanel, java.awt.BorderLayout.LINE_START);

        playerFourPanel.setLayout(new java.awt.BorderLayout());
        add(playerFourPanel, java.awt.BorderLayout.LINE_END);

        deckPanel.setLayout(new java.awt.GridLayout());

        drawButton.setText("Draw");
        deckPanel.add(drawButton);

        discardedButton.setText("Discarded");
        deckPanel.add(discardedButton);
    ...
    private javax.swing.JButton discardedButton;
